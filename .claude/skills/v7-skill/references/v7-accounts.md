...
## 로컬 개발 환경의 관리자 session_id_v7

아래의 세션 아이디로 로그인하면 로컬 개발 환경에서 관리자 권한으로 작업할 수 있습니다. 이 계정은 개발 및 테스트 목적으로만 사용해야 합니다.

> **⛔ 중요**: v7 세션 쿠키 이름은 `session_id_v7`이다. `session_id`가 아님에 주의. (`AuthService::SESSION_KEY = 'session_id_v7'`)

- 로컬 개발 관리자 session_id_v7: `090e2895f9280a7d7d6ec11d3f0ce483-186619`
...
- Password: `12345a,*`
- session_id_v7: `2278018daa75e0ab879d8791fb0e2b2d-190076`
...
- session_id_v7: `d87e7374e22f1bf1aaebbbb97d280115-193824`
