  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          _sectionTitle(context, FontAwesomeIcons.locationDot, '위치'),
          const SizedBox(height: 16),
          FormFieldLabel(
            label: '지역',
            child: TextFormField(
              controller: locationController,
              decoration: formInputDecoration('예: 마닐라, 세부, 다바오'),
            ),
          ),
          const SizedBox(height: 16),
          FormFieldLabel(
            ...
            child: TextFormField(
              ...
              decoration: formInputDecoration('상세 주소를 입력하세요'),
              maxLines: 2,
            ),
          ),
          const SizedBox(height: 28),
          _sectionTitle(context, FontAwesomeIcons.addressBook, '연락처'),
          const SizedBox(height: 16),
          FormFieldLabel(
            label: '전화번호',
            child: TextFormField(
          ...
          FormFieldLabel(
            ...
            child: TextFormField(
              ...
              decoration: formInputDecoration('예: +63-917-123-4567'),
              keyboardType: TextInputType.phone,
            ),
          ),
          const SizedBox(height: 28),
          _sectionTitle(context, FontAwesomeIcons.commentDots, '메신저'),
          const SizedBox(height: 16),
          FormFieldLabel(
            label: '카카오톡 ID',
            child: TextFormField(
              controller: kakaoController,
              decoration: formInputDecoration('오픈채팅 ID 또는 링크'),
            ),
          ),
          const SizedBox(height: 16),
          FormFieldLabel(
            ...
            child: TextFormField(
              ...
              decoration: formInputDecoration('사용자명 또는 링크'),
            ),
          ),
        ],
      ),
