...
| `layout/layout.header-mobile.php` | 모바일 헤더 (빠른 링크 + 검색/햄버거 + v6형 확장 메뉴 패널). "오늘" 링크 → `/today` | 모바일(<992px) | `v7-header-mobile`, `v7-mobile-only` |
| `layout/layout.header-desktop.php` | 데스크톱 헤더 (로고, 검색, 4열 메뉴). "오늘" 링크 → `/today` | 데스크톱(>=992px) | `v7-header-desktop`, `v7-lg` |
