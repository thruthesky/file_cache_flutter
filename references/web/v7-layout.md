...
| 용도 | 색상 코드 | 사용 위치 |
|------|----------|----------|
| **주요 브랜드색** | `#7f1d1d` | 메뉴 헤더, 뉴스탭 active, 순위 뱃지, 섹션 제목 하단 보더 |
| **강조 빨강** | `#dc2626` | 인기글 상위 3 순위 뱃지 |
...
> **⛔ 절대 규칙**: 브랜드색 `#7f1d1d`와 강조색 `#dc2626`은 v6과 동일하게 유지해야 한다. 변경 시 전체 사이트 디자인 일관성이 깨진다.
